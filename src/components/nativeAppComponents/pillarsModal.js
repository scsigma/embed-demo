        ...
        <div id="intro-page" style={{display: "flex", height: "350px", width: "350px", flexDirection: "column", alignContent: "center", justifyContent:"center"}}>
          ...
          <div id="start-button" style={{height: "50px", position: "absolute", top: "450px", zIndex: "2", width: "300px", display:"flex", alignContent: "center", justifyContent: "center", padding:"25px"}}>
            {showElement && isVisible ? (
              <Button onClick={handleButtonClick} style={{ backgroundColor: 'white', border: '2px solid #4245FF', borderRadius: '8px', fontFamily: 'Lato', fontSize: '24px', fontWeight:"700", color: '#4245FF' }}>Start the tutorial</Button>
              ) : null}
          </div>
      ...
      {isVisible && modalStep === 2 && (
        <div id="pillar-container" style={{width: "1200px", height:"750px", display: "flex", flexDirection: "column"}}>
            ...
            <div id="title" style={{width: "100%", height:"50px", display: "flex", alignContent:"center", justifyContent:"center"}}>
              <Button onClick={nextPage} style={{backgroundColor: "white", border:"2px solid #4245FF", borderRadius: "8px", fontFamily: "Lato", fontSize: "24px", fontWeight: "700", color: "#4245FF"}}>Enter Plugs Portal</Button>
            </div>
        </div>
        )}
      </AppContainer>
